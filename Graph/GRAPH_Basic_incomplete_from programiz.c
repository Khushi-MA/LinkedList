...
int directedorundirected(int[20][20], int);
void showadjacency(int[20][20], int);
void listadjacency(int[20][20],int);
...
void main()
{
    ...
    switch(ch)
    {
         ...
         case 5: showadjacency(a,n);
                 break;

         case 6: listadjacency(a,n);
                 break;
...
void showadjacency(int A[20][20], int N)
{
    int i,j;
    for(i=1;i<=N;i++)
    {
...
void listadjacency(int A[20][20],int N)
{
    int i, j;
